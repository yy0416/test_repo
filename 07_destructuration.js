 ...
 */
 arr2 = {name: "toto", age: 42};
const extractName = ({name})=>name;
console.log(extractName(arr2));
 ...
 * 
 */
arr3 = {name2: "toto", password: "1234",age:5};

const removePassword =  ({password, ...rest2}) =>rest2;
console.log(removePassword(arr3));
